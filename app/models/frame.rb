...
class Frame < ApplicationRecord # rubocop:disable Metrics/ClassLength
  ...
  has_many :target_moves, class_name: "Move", inverse_of: :frame, dependent: :destroy
  has_many :origin_moves, class_name: "Move", foreign_key: :prev_frame_id, inverse_of: :prev_frame, dependent: :destroy
