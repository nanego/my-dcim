...
class GlpiClient # rubocop:disable Metrics/ClassLength
  ...
  def stubs
    Faraday::Adapter::Test::Stubs.new do |stub|
      ...
      stub.get("/NetworkEquipment?searchText%5Bserial%5D=AZERTY") { |_env| [200, {}, Rails.root.join("test/services/network_equipments_results.json").read] }
      stub.get(%r{/Computer/4090?.*}) { |_env| [200, {}, Rails.root.join("test/services/computer_4090_algori.json").read] }
      stub.get("/NetworkEquipment/5000?.*") { |_env| [200, {}, Rails.root.join("test/services/network_equipment_5000_algori.json").read] }
