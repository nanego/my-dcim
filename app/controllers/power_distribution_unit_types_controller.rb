...
class PowerDistributionUnitTypesController < ApplicationController
  ...
  def power_distribution_unit_type_params
    params.expect(
      power_distribution_unit_type: %i[
        manufacturer_id name current_type documentation_url meter_global meter_per_socket meter_per_circuit socket_control socket_lock ip_snmp
