...
class ButtonComponent < ApplicationComponent
  ...
  def initialize(title:, url:, variant: :default, icon: nil, is_responsive: false, extra_classes: "")
    @title = title
    @url = url
  ...
  def call
    link_to @url, class: "btn btn-#{@variant} align-self-center d-inline-flex #{@extra_classes}", title: @title do
