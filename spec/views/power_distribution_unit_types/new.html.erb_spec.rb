...
RSpec.describe "power_distribution_unit_types/new" do
  before do
    assign(:power_distribution_unit_type, PowerDistributionUnitType.new(
                                            manufacturer: nil,
                                            name: "MyString",
                                            current_type: 1,
  ...
  it "renders new power_distribution_unit_type form" do
    render

    assert_select "form[action=?][method=?]", power_distribution_unit_types_path, "post" do
